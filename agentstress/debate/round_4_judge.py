...
from agentstress.evaluation.judge_gpt import GPTJudge, FailureClassification
...
class Round4Judge:
    ...
    def run(
        ...
        return {
            "judgments": judgments,
            "overall_reliability_score": sum(
                [j["rubric_score"].percentage for j in judgments.values()]
            )
            / len(judgments),
        }
