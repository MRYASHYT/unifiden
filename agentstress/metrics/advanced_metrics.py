...
class AdvancedMetrics:
    ...
    def calculate_stubbornness_score(
        self, round1_ans: str, round2_feedback: str, round3_ans: str
    ) -> float:
    ...
    def calculate_hallucination_propagation(
        self, source_agent_id: str, peer_agents_data: list
    ) -> dict:
    ...
    def calculate_debate_metrics(self, agent_id: str, round1_res: dict, round3_res: dict) -> dict:
        ...
        return {"stubbornness": stubbornness, "collapse": 0.0}  # To be implemented
