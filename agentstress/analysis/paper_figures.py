...
class PaperFigures:
    ...
    def plot_failure_rates(self, df: pd.DataFrame):
        ...
        plot = sns.barplot(x="instruction_type", y="percentage", hue="architecture", data=df, palette="viridis")
    ...
    def plot_failure_mode_pie(self, df: pd.DataFrame):
        ...
        plt.pie(counts, labels=counts.index, autopct='%1.1f%%', startangle=140, colors=sns.color_palette("magma"))
