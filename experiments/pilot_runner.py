...
def run_pilot():
    ...
    task_id = "pilot_task_1"
    
    rubric_data = {
        "required_elements": ["Title", "Author", "2023"],
        "forbidden_elements": ["2017", "Attention is all you need"] # Example forbidden classic
    }
    ...
    rubric_score = rubric_engine.score_output(task_id, agent.agent_id, agent_result.output, rubric_data)
    
    print("Classifying Failure Mode...")
    # Convert tool calls to dicts for the judge
...
if __name__ == "__main__":
    ...
    if not os.getenv("OPENAI_API_KEY"):
        print("ERROR: OPENAI_API_KEY not found in .env. Please add it before running the pilot.")
    else:
        run_pilot()
