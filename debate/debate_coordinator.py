...
from debate.round_4_judge import Round4Judge
...
class DebateCoordinator:
    ...
    def run_debate(self, instruction: str, instruction_type: str, rubric: dict) -> dict:
        ...
        final_judgment = self.round4.run(instruction, instruction_type, round1_results, round2_results, round3_results, rubric)
